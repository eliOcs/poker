        ...
        <main class="main">
          <div class="container">
            ...
            <ul>
              ...
              <li>
                Sit out toggle moved from action panel to navigation drawer
              </li>
            ...
            <ul>
              <li>
                Fixed shown cards not raised for opponents during showdown
              </li>
            ...
            <ul>
              ...
              <li>
                History timeline: muted street headers, fit-to-width layout
              </li>
              ...
              <li>
                UI polish on seat button, sit out styling, and empty seats
              </li>
            </ul>
            <h3>Bug Fixes</h3>
            <ul>
            ...
            <ul>
              <li>
                Cash game defaults changed to 6-max and $0.02/$0.05 blinds
              </li>
            ...
            <ul>
              <li>
                Fixed betting slider unable to reach max when stack not
                divisible by step
              </li>
              <li>
                Fixed all-in action incorrectly shown as "Call" instead of
                "Raise"
              </li>
            ...
            <ul>
              <li>
                Fixed non-participating players showing "$0" during showdown
                (now shows stack)
              </li>
            ...
            <ul>
              ...
              <li>
                Timeline shows all actions street-by-street (Preflop, Flop,
                Turn, River, Showdown)
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                Winner highlighting now matches between live game and hand
                history
              </li>
            </ul>
            <h4>Call Clock</h4>
            ...
            <ul>
              <li>
                Fixed hand history sometimes showing 7 cards on board instead of
                5
              </li>
              <li>
                Fixed history error page - now redirects back to game with a
                toast message
              </li>
              <li>
