...
/**
 * Shared table chrome for compact modal tables.
 */
export const modalTableStyles = css`
  .table-wrap {
    overflow-x: auto;
  }
  ...
  table {
    width: 100%;
    min-width: var(--modal-table-min-width, 0);
    border-collapse: collapse;
  }
  ...
  @media (width < 800px) {
    table {
      min-width: var(--modal-table-mobile-min-width, 0);
    }
