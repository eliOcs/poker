 ...
 * @property {'default'|'currency'|'bb'} [amountDisplay] - Table amount display preference
 * @property {import('../shared/avatar.js').AvatarConfiguration} [avatar] - Saved avatar configuration
 */
