    ...
    return historyView({
      ...
      handList: [
        createHandListItem({
          ...
          pot: 850,
          is_winner: false,
          board_cards: ["Kd", "5h", "2c", "Ac", "3s"],
          net_result: -550,
          winner_hole_cards: ["As", "Ad"],
        }),
      ],
      hand,
    ...
    return historyView({
      ...
      handList: [
        ...
        createHandListItem({
          ...
          pot: 200,
          is_winner: false,
          board_cards: ["Qc", "7h", "3d", "Qs", "5c"],
          net_result: -100,
          winner_hole_cards: ["Ah", "Qh"],
        }),
        createHandListItem({
          ...
          pot: 350,
          is_winner: true,
          board_cards: ["Ks", "8h", "2c", "4d", "Jc"],
          net_result: 175,
          winner_hole_cards: ["Qc", "Qd"],
        }),
        createHandListItem({
        ...
        createHandListItem({
          ...
          pot: 500,
          is_winner: true,
          board_cards: ["9c", "7h", "2s", "Kd", "3c"],
          net_result: 250,
          winner_hole_cards: ["9h", "9s"],
        }),
        createHandListItem({
          game_number: "test123-6",
          hand_number: 6,
          hole_cards: ["Ac", "Kd"],
          winner_name: "Alice",
          winner_id: "player2",
          pot: 300,
          is_winner: false,
          board_cards: ["Qs", "Jh", "4c", "8d", "2s"],
          net_result: -150,
          winner_hole_cards: ["Qs", "Qd"],
        }),
        createHandListItem({
          game_number: "test123-7",
          hand_number: 7,
          hole_cards: ["Th", "Td"],
          winner_name: "Bob",
          pot: 400,
          is_winner: true,
          board_cards: ["Ts", "6h", "3c", "Kc", "9d"],
          net_result: 200,
          winner_hole_cards: ["Th", "Td"],
        }),
        createHandListItem({
          game_number: "test123-8",
          hand_number: 8,
          hole_cards: ["5d", "5c"],
          winner_name: "Alice",
          winner_id: "player2",
          ...
          net_result: -125,
          winner_hole_cards: ["As", "Jd"],
        }),
        createHandListItem({
          game_number: "test123-9",
          hand_number: 9,
          hole_cards: ["Ah", "Jh"],
          winner_name: "Bob",
          pot: 600,
          is_winner: true,
          board_cards: ["Kh", "9h", "2h", "4d", "Qc"],
          net_result: 300,
          winner_hole_cards: ["Ah", "Jh"],
        }),
        createHandListItem({
          game_number: "test123-10",
          hand_number: 10,
          hole_cards: ["8s", "7s"],
          winner_name: "Alice",
          winner_id: "player2",
          pot: 450,
          is_winner: false,
          board_cards: ["Kd", "Qh", "3s", "Jc", "6d"],
          net_result: -225,
          winner_hole_cards: ["Kd", "Kc"],
        }),
        createHandListItem({
          game_number: "test123-11",
          hand_number: 11,
          hole_cards: ["Ks", "Qd"],
          winner_name: "Bob",
          pot: 350,
          is_winner: true,
          board_cards: ["Kc", "8h", "4s", "2d", "7c"],
          net_result: 175,
          winner_hole_cards: ["Ks", "Qd"],
        }),
        createHandListItem({
          game_number: "test123-12",
          hand_number: 12,
          hole_cards: ["6h", "6d"],
          winner_name: "Alice",
          winner_id: "player2",
          pot: 500,
          is_winner: false,
          board_cards: ["As", "Qc", "9s", "3h", "Jd"],
          net_result: -250,
          winner_hole_cards: ["As", "Qs"],
        }),
        createHandListItem({
          game_number: "test123-13",
          hand_number: 13,
          hole_cards: ["Ad", "Td"],
          winner_name: "Bob",
          pot: 200,
          is_winner: true,
          board_cards: ["Jd", "8d", "3c"],
          net_result: 100,
          winner_hole_cards: ["Ad", "Td"],
        }),
        createHandListItem({
          game_number: "test123-14",
          hand_number: 14,
          hole_cards: ["4h", "4c"],
          winner_name: "Alice",
          winner_id: "player2",
          pot: 300,
          is_winner: false,
          board_cards: ["Ks", "Th", "7d", "2c", "9s"],
          net_result: -150,
          winner_hole_cards: ["Ks", "Jc"],
        }),
        createHandListItem({
          game_number: "test123-15",
          hand_number: 15,
          hole_cards: ["Jh", "Ts"],
          winner_name: "Bob",
          pot: 800,
          is_winner: true,
          board_cards: ["Qd", "9c", "8h", "2s", "4d"],
          net_result: 400,
          winner_hole_cards: ["Jh", "Ts"],
        }),
      ],
      hand,
      view: createMockView(hand, "player1"),
