...
const TEST_CASES = {
  ...
  "game-waiting-for-players": () => gameView(createGame({
    seats: [
      createPlayer("You", {
  ...
  "game-ready-to-start": () => gameView(createGame({
    seats: [
      createPlayer("You", {
        isCurrentPlayer: true,
        stack: 5000,
  ...
  "game-countdown": () => gameView(createGame({
    countdown: 3,
    seats: [
  ...
  "game-preflop-your-turn": () => gameView(createGame({
    button: 1,
  ...
  "game-preflop-waiting": () => gameView(createGame({
    button: 0,
  ...
  "game-flop-check-or-bet": () => gameView(createGame({
    button: 0,
  ...
  "game-flop-facing-bet": () => gameView(createGame({
    button: 1,
  ...
  "game-river-all-in-decision": () => gameView(createGame({
    button: 1,
  ...
  "game-showdown-you-lose": () => gameView(createGame({
    button: 0,
    hand: { phase: "showdown", pot: 0, currentBet: 0, actingSeat: -1 },
    board: {
      cards: [
  ...
  "game-all-in-situation": () => gameView(createGame({
    button: 0,
  ...
  "game-with-folded-players": () => gameView(createGame({
    button: 0,
  ...
  "game-clock-called": () => gameView(createGame({
    button: 0,
    hand: { phase: "flop", pot: 300, currentBet: 100, actingSeat: 1, clockCalledAt: Date.now() - 15000 },
    board: {
      cards: [
        { rank: "jack", suit: "hearts" },
  ...
  "game-sitting-out": () => gameView(createGame({
    button: 1,
  ...
  "game-disconnected-player": () => gameView(createGame({
    button: 0,
  ...
  "game-full-table": () => gameView(createGame({
    button: 0,
  ...
  "game-buy-in": () => gameView(createGame({
    seats: [
      {
        empty: false,
  ...
  "game-error": () => gameView(createGame({
    seats: [
      createPlayer("You", { isCurrentPlayer: true, stack: 5000 }),
      createPlayer("Alice", { stack: 3000 }),
      { ...mockEmptySeat, actions: [] },
  ...
  "game-rankings-modal": () => gameView(createGame({
    seats: [
      createPlayer("You", {
        isCurrentPlayer: true,
        stack: 6200,
...
function init() {
  ...
  if (!testId) {
    ...
    const categories = {
      ...
      "Lobby": ["game-empty-table", "game-waiting-for-players", "game-ready-to-start", "game-countdown", "game-buy-in"],
      ...
      "Special States": ["game-all-in-situation", "game-with-folded-players", "game-clock-called", "game-sitting-out", "game-disconnected-player", "game-full-table"],
