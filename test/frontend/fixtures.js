  ...
  rounds: [
    {
      ...
      actions: [
        ...
        { action_number: 4, player_id: "player2", action: "Dealt Cards", cards: ["Qc", "Jc"] },
  ...
  rounds: [
    ...
    },
    {
      ...
      actions: [
        ...
        { action_number: 13, player_id: "player1", action: "Call", amount: 100 },
      ],
    },
    {
      id: 4,
      street: "Showdown",
      actions: [
        { action_number: 14, player_id: "player1", action: "Shows Cards", cards: ["Ah", "Kh"] },
        { action_number: 15, player_id: "player2", action: "Shows Cards", cards: ["Qc", "Jc"] },
      ],
    },
  ],
};
